    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (
                ...
                request.getServletPath().equals("/api/v1/token/refresh") ||
                        ...
                        (request.getServletPath().contains("/api/v1/reservations") &&  request.getMethod().equals("GET")) ||
                        (request.getServletPath().contains("/api/v1/rooms") && request.getMethod().equals("GET"))
        ) {
            ...
            if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
                try {
                    ...
                    error.put("error_message", "Error while authorization... Please check login and password");
